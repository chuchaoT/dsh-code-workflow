...
English | [中文](autodev.zh.md)

AutoDev is an optional DeepSeek Harness Bundle for resumable, auditable software-engineering runs. It is a workflow service, not a replacement Agent runtime: it routes work through Providers already loaded by DSH and keeps Host authority over durable state, verification, and promotion. The [package guide](../../packages/experimental/autodev/README.md) covers installation and operator workflows.

## Ownership and safety boundaries

- The Host `ctx.autodev` service owns Run state, Plans, Attempts, Evidence, project knowledge, and recovery. The [AutoDev source](../../packages/experimental/autodev/src/runtime.ts) coordinates these transitions.
- Provider execution receives a managed Git Worktree, not the original checkout. Codex and Claude Code remain Harness-owned Provider integrations; AutoDev does not duplicate their login or process management.
- Each implementation attempt receives optional v1 Agent context cards for scoped Memory, Plan-linked Business Concepts, Playbooks, Run-local Assumptions and Semantic Uncertainty, and Knowledge. The Host caps all six groups together at 6,000 characters, validates the Provider-bound context, and retains an `AGENT_CONTEXT` Artifact.
- Provider output and Agent signals are claims, not verification. The Host binds Build/Test Evidence to the active Plan, Attempt, and Candidate before it makes promotion available.
- The Client calls bounded Remote methods. It cannot write the SQLite store or bypass Gate checks; promotion remains an explicit, revalidated Host action.

## Domain contract ownership

The public Remote signatures below are generated from the Host service. Shared wire records live in [`src/contracts.ts`](../../packages/experimental/autodev/src/contracts.ts); Agent messages and signal envelopes live in [`src/protocol.ts`](../../packages/experimental/autodev/src/protocol.ts); Provider selection lives in [`src/router.ts`](../../packages/experimental/autodev/src/router.ts). Project Memory, Business Concepts, Playbooks, assumptions, uncertainty, Knowledge, and compaction remain separate domain services in the package and are scoped by the Host-derived project identity.
...
Types: [ArtifactContent](../../packages/experimental/autodev/README.md#public-api-contracts) · [AutoDevAuditActor](../../packages/experimental/autodev/README.md#public-api-contracts) · [AutoDevBackupManifest](../../packages/experimental/autodev/README.md#public-api-contracts) · [AutoDevCleanupJobView](../../packages/experimental/autodev/README.md#public-api-contracts) · [AutoDevRetentionPreview](../../packages/experimental/autodev/README.md#public-api-contracts) · [AutoDevSnapshot](../../packages/experimental/autodev/README.md#public-api-contracts) · [BusinessConcept](../../packages/experimental/autodev/README.md#public-api-contracts) · [CreateRunRequest](../../packages/experimental/autodev/README.md#public-api-contracts) · [EvidenceType](../../packages/experimental/autodev/README.md#public-api-contracts) · [ExecuteRetentionCleanupRequest](../../packages/experimental/autodev/README.md#public-api-contracts) · [KnowledgeCandidate](../../packages/experimental/autodev/README.md#public-api-contracts) · [KnowledgeRegressionCase](../../packages/experimental/autodev/README.md#public-api-contracts) · [KnowledgeSearchHit](../../packages/experimental/autodev/README.md#public-api-contracts) · [MemorySearchHit](../../packages/experimental/autodev/README.md#public-api-contracts) · [Playbook](../../packages/experimental/autodev/README.md#public-api-contracts) · [PrepareRetentionCleanupRequest](../../packages/experimental/autodev/README.md#public-api-contracts) · [ProjectMemory](../../packages/experimental/autodev/README.md#public-api-contracts) · [ProviderCatalog](../../packages/experimental/autodev/README.md#public-api-contracts) · [ProviderInfo](../../packages/experimental/autodev/README.md#public-api-contracts) · [ProviderRouter](../../packages/experimental/autodev/README.md#public-api-contracts) · [Run](../../packages/experimental/autodev/README.md#public-api-contracts)
